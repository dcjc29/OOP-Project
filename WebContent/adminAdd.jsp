...
<!---------------------------------------------------------------------------------------------------------->
  ...
  <form  method="POST" action="AddAdminServlet"  role="form">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                           <label>Re-Type Password</label>
                              <input  type="password" name="passwordC" id="passwordC" class="form-control" placeholder="Enter Password">
                    </div>              
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                             <label>Mobile No</label>
                              <input type="text" name="mobile" id="mobile"  class="form-control" placeholder="Ex :0712345678">
                    </div>
        ...
        <td colspan="2"><input type="submit" value="Add Admin" class="btn btn-gradient-primary mr-2" /> </td>
