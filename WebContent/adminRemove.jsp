...
<%if(request.getSession(false).getAttribute("currentUser")!=null){%>
  ...
  <div class="container-scroller">
    ...
    <thead>
      <tr>
        <th class="th-sm">Admin Username</th>
        <th class="th-sm">Admin Email</th>
        <th class="th-sm">Admin Contact No</th>
...
%>
	 <tr id="<%=admin.getId()%>">
        ...
        <td data-target="itemTitle"><%out.println(admin.getUserName());%></td>
        <td data-target="noOfItems"><%out.println(admin.getEmail());%></td>
        <td data-target="itemDescription"><%out.println(admin.getMobileNo());%></td>
        
        <td>
		<button type="button" data-id="<%=admin.getId()%>" class="btn btn-danger deleteBtn">Delete</button>
        </td>
      </tr>
<%
