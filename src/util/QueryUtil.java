...
public class QueryUtil extends CommonUtil{
		...
		public static String queryByID(String id) throws SAXException, IOException, ParserConfigurationException {
			 ...
			 */
			nodeList = DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new File("/home/dureksha/eclipse-workspace/BidWars/WebContent/WEB-INF/BidWarsQuery.xml"))
